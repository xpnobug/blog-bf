/*! Browser bundle of nunjucks 3.0.1  */ ! function(e, t) {
    ...
    return function(e) {
        ...
        var i = n(1),
            ...
            o = n(15),
            a = n(3);
        e.exports = {}, e.exports.Environment = r.Environment, e.exports.Template = r.Template, e.exports.Loader = s, e.exports.FileSystemLoader = o.FileSystemLoader, e.exports.PrecompiledLoader = o.PrecompiledLoader, e.exports.WebLoader = o.WebLoader, e.exports.compiler = n(7), e.exports.parser = n(8), e.exports.lexer = n(9), e.exports.runtime = n(13), e.exports.lib = i, e.exports.nodes = n(10), e.exports.installJinjaCompat = n(22);
        var l;
        ...
        t.prettifyError = function(e, n, i) {
            ...
            var n = [];
            if (!e) return n;
            for (var i = -1, r = e.length, s = t.toArray(arguments).slice(1); ++i < r;) t.indexOf(s, e[i]) === -1 && n.push(e[i]);
            return n
            ...
            var i = this.length >>> 0;
            for (n = +n || 0, Math.abs(n) === 1 / 0 && (n = 0), n < 0 && (n += i, n < 0 && (n = 0)); n < i; n++)
                if (e[n] === t) return n;
            return -1
        ...
        var v = l.extend({
                ...
                resolveTemplate: function(e, t, n) {
                    var i = !(!e.isRelative || !t) && e.isRelative(n);
                    return i && e.resolve ? e.resolve(t, n) : n
                },
                getTemplate: function(e, t, n, i, s) {
                    var o = this,
                        l = null;
                    if (e && e.raw && (e = e.raw), a.isFunction(n) && (s = n, n = null, t = t || !1), a.isFunction(t) && (s = t, t = !1), e instanceof r) l = e;
                    else {
            ...
            g = l.extend({
                ...
                getSuper: function(e, t, n, i, r, s) {
                    var o = a.indexOf(this.blocks[t] || [], n),
                        l = this.blocks[t][o + 1],
                        c = this;
                    if (o === -1 || !l) throw new Error('no super block available for "' + t + '"');
                    l(e, c, i, r, s)
                },
        ...
        r = l.extend({
            init: function(e, t, n, i) {
                if (this.env = t || new v, a.isObject(e)) switch (e.type) {
                    case "code":
            ...
            render: function(e, t, n) {
                ...
                try {
                    ...
                    var o = a.prettifyError(this.path, this.env.opts.dev, e);
                    if (n) return i(n, o);
                    throw o
                }
                ...
                c.topLevel = !0;
                var h = null;
                return s.rootRenderFunc(s.env, l, c || new d, p, function(e, t) {
                    if (e && (e = a.prettifyError(s.path, s.env.opts.dev, e)), n) r ? i(n, e, t) : n(e, t);
                    else {
                        if (e) throw e;
                        h = t
                    }
            ...
            getExported: function(e, t, n) {
                ...
                var i = t ? t.push() : new d;
                i.topLevel = !0;
                var r = new g(e || {}, this.blocks, this.env);
                this.rootRenderFunc(this.env, r, i, p, function(e) {
        ...
        (function(t) {
            ...
            o = "function" == typeof p ? r(i) : s(i), n.requestFlush = o, n.makeRequestCallFromTimer = s
        }).call(t, function() {
            return this
        }())
    }, function(e, t) {
        ...
        var r = n(1),
            ...
            u = l.extend({
                ...
                compileCallExtension: function(e, t, n) {
                    var i = e.args,
                        s = e.contentArgs,
                        o = "boolean" != typeof e.autoescape || e.autoescape;
                ...
                compileOutput: function(e, t) {
                    for (var n = e.children, i = 0, r = n.length; i < r; i++) n[i] instanceof a.TemplateData ? n[i].value && (this.emit(this.buffer + " += "), this.compileLiteral(n[i], t), this.emitLine(";")) : (this.emit(this.buffer + " += runtime.suppressValue("), this.throwOnUndefined && this.emit("runtime.ensureDefined("), this.compile(n[i], t), this.throwOnUndefined && this.emit("," + e.lineno + "," + e.colno + ")"), this.emit(", env.opts.autoescape);\n"))
                },
                compileRoot: function(e, t) {
                    ...
                    for (n = 0; n < o.length; n++) {
                        if (r = o[n], i = r.name.value, s.indexOf(i) !== -1) throw new Error('Block "' + i + '" defined more than once.');
                        s.push(i), this.emitFuncBegin("b_" + i);
                        var l = new c;
                        this.emitLine("var frame = frame.push(true);"), this.compile(r.body, l), this.emitFuncEnd()
                    }
        ...
        var i = n(9),
            ...
            a = s.extend({
                ...
                parseFor: function() {
                    ...
                    this.skipSymbol("for") ? (e = new r.For(n.lineno, n.colno), t = "endfor") : this.skipSymbol("asyncEach") ? (e = new r.AsyncEach(n.lineno, n.colno), t = "endeach") : this.skipSymbol("asyncAll") ? (e = new r.AsyncAll(n.lineno, n.colno), t = "endall") : this.fail("parseFor: expected for{Async}", n.lineno, n.colno), e.name = this.parsePrimary(), e.name instanceof r.Symbol || this.fail("parseFor: variable name expected for loop");
                ...
                parseStatement: function() {
                    var e, t = this.peekToken();
                    if (t.type !== i.TOKEN_SYMBOL && this.fail("tag name expected", t.lineno, t.colno), this.breakOnBlocks && o.indexOf(this.breakOnBlocks, t.value) !== -1) return null;
                    switch (t.value) {
                        case "raw":
                        ...
                        default:
                            if (this.extensions.length)
                                for (var n = 0; n < this.extensions.length; n++) {
                                    ...
                                    if (o.indexOf(s.tags || [], t.value) !== -1) return s.parse(this, r, i)
                                }
                ...
                parseRaw: function(e) {
                    e = e || "raw";
                    for (var t = "end" + e, n = new RegExp("([\\s\\S]*?){%\\s*(" + e + "|" + t + ")\\s*(?=%})%}"), i = 1, s = "", o = null, a = this.advanceAfterBlockEnd();
                ...
                parsePostfix: function(e) {
                    for (var t, n = this.peekToken(); n;) {
                        ...
                        else if (n.type === i.TOKEN_LEFT_BRACKET) t = this.parseAggregate(), t.children.length > 1 && this.fail("invalid index"), e = new r.LookupVal(n.lineno, n.colno, e, t.children[0]);
                        else {
        ...
        r.prototype.nextToken = function() {
            ...
            if (this.in_code) {
                ...
                if ((e = this._extractString(this.tags.VARIABLE_END)) || (e = this._extractString("-" + this.tags.VARIABLE_END))) return this.in_code = !1, i(b, e, t, n);
                if ("r" === r && "/" === this.str.charAt(this.index + 1)) {
                    ...
                    for (var h = ["g", "i", "m", "y"], u = ""; !this.is_finished();) {
                        var p = h.indexOf(this.current()) !== -1;
                        if (!p) break;
                ...
                if (a.indexOf(r) !== -1) {
                    ...
                    var f, m = ["==", "===", "!=", "!==", "<=", ">=", "//", "**"],
                        j = r + this.current();
                    switch (s.indexOf(m, j) !== -1 && (this.forward(), r = j, s.indexOf(m, j + this.current()) !== -1 && (r = j + this.current(), this.forward())), r) {
                        case "(":
                            f = w;
                            break;
                        case ")":
                ...
                if (e = this._extractUntil(o + a), e.match(/^[-+]?[0-9]+$/)) {
                    if ("." === this.current()) {
                        this.forward();
                        var V = this._extract(l);
                        return i(R, e + "." + V, t, n)
                    }
                    return i(I, e, t, n)
                }
                if (e.match(/^(true|false)$/)) return i(K, e, t, n);
            ...
            if ((e = this._extractString(this.tags.VARIABLE_START + "-")) || (e = this._extractString(this.tags.VARIABLE_START))) return this.in_code = !0, i(x, e, t, n);
            e = "";
            var W, G = !1;
            for (this._matches(this.tags.COMMENT_START) && (G = !0, e = this._extractString(this.tags.COMMENT_START)); null !== (W = this._extractUntil(U));) {
                if (e += W, (this._matches(this.tags.BLOCK_START) || this._matches(this.tags.VARIABLE_START) || this._matches(this.tags.COMMENT_START)) && !G) {
                    if (this.lstripBlocks && this._matches(this.tags.BLOCK_START) && this.colno > 0 && this.colno <= e.length) {
                        ...
                        if (/^\s+$/.test(H) && (e = e.slice(0, -this.colno), !e.length)) return this.nextToken()
                    }
                    break
                }
            ...
            if (e && n === -1 || !e && n !== -1) {
                ...
                for (var r = t.indexOf(this.current());
                    (e && r === -1 || !e && r !== -1) && !this.is_finished();) i += this.current(), this.forward(), r = t.indexOf(this.current());
                return i
            }
            return ""
            ...
            if (this.index--, "\n" === this.current()) {
                ...
                e === -1 ? this.colno = this.index : this.colno = this.index - e
            } else this.colno--
        ...
        (function(t) {
            ...
            var s = n(1),
                ...
                a = o.extend("Node", {
                    ...
                    findAll: function(e, t) {
                        ...
                        if (this instanceof c) {
                            var s = this.children;
                            for (n = 0, r = s.length; n < r; n++) i(s[n], e, t)
                        } else {
                            var o = this.fields;
                            for (n = 0, r = o.length; n < r; n++) i(this[o[n]], e, t)
                        }
                        return t
                    },
                ...
                re = a.extend("CompareOperand", {
                    fields: ["expr", "type"]
                }),
                se = a.extend("CallExtension", {
        ...
        function a(e, t, n) {
            var r = [],
                s = o(n ? e[n] : e, function(e) {
                    ...
                    if (e instanceof f.Filter && m.indexOf(t, e.name.value) !== -1 || e instanceof f.CallExtensionAsync) {
        ...
        function g(e, t, n, i) {
            ...
            var s, o, a, l = 0;
            if (y.isArray(e))
                if (s = e.length, a = new Array(s), 0 === s) i(null, "");
                else
                    for (o = 0; o < e.length; o++) {
                        ...
                        var h = y.keys(e);
                        if (s = h.length, a = new Array(s), 0 === s) i(null, "");
                        else
            ...
            x = k.extend({
                ...
                resolve: function(e, t) {
                    var n = t && this.isolateWrites ? void 0 : this.parent,
                        i = this.variables[e];
                    return void 0 !== i ? this : n && n.resolve(e)
                },
                push: function(e) {
                    return new x(this, e)
                },
        ...
        var r = n(1),
            ...
            o = {
                ...
                replace: function(e, t, n, i) {
                    ...
                    var a = e.indexOf(t);
                    if (0 === i || a === -1) return e;
                    for (var l = 0, c = 0; a > -1 && (i === -1 || c < i);) o += e.substring(l, a) + n, l = a + t.length, c++, a = e.indexOf(t, l);
                ...
                sort: s.makeMacro(["value", "reverse", "case_sensitive", "attribute"], [], function(e, t, n, i) {
                    return e = r.map(e, function(e) {
                        ...
                        var o, a;
                        return i ? (o = e[i], a = s[i]) : (o = e, a = s), !n && r.isString(o) && r.isString(a) && (o = o.toLowerCase(), a = a.toLowerCase()), o < a ? t ? 1 : -1 : o > a ? t ? -1 : 1 : 0
                    }), e
                }),
                string: function(e) {
        ...
        (function(e, t) {
            ! function(e, n) {
                ...
                if (!e.setImmediate) {
                    ...
                    y = y && y.setTimeout ? y : e, "[object process]" === {}.toString.call(e.process) ? a() : l() ? c() : e.MessageChannel ? h() : g && "onreadystatechange" in g.createElement("script") ? u() : p(), y.setImmediate = i, y.clearImmediate = r
                }
        ...
        function n() {
            ...
            function n(e, t, n, r) {
                ...
                for (var s = [], o = t; !(o < 0 || o > e.length) && !(r > 0 && o >= n) && !(r < 0 && o <= n); o += r) s.push(i.memberLookup(e, o));
                return s
            }
            var i = this.runtime,
                r = this.lib,
                ...
                p = i.memberLookup;
            i.contextOrFrameLookup = function(e, t, n) {
            ...
            s.prototype.assertType = function(e) {
                ...
                try {
                    ...
                    r.extend(this.tokens, n), this.peeked = !1;
                    var o = this.peekToken();
                    if (o.type !== l.TOKEN_LEFT_BRACKET) throw s();
                    this.nextToken();
                    for (var c = new f(o.lineno, o.colno), h = !1, p = 0; p <= c.fields.length && !this.skip(l.TOKEN_RIGHT_BRACKET); p++) {
                        if (p === c.fields.length) {
                            if (!h) break;
                            this.fail("parseSlice: too many slice components", o.lineno, o.colno)
                        }
                        if (this.skip(l.TOKEN_COLON)) h = !0;
                        else {
                            var m = c.fields[p];
                            c[m] = this.parseExpression(), h = this.skip(l.TOKEN_COLON) || h
                        }
                    }
                    if (!h) throw s();
                    return new a.Array(o.lineno, o.colno, [c])
                }
            };
            var m = {
                    pop: function(e) {
