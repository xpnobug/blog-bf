        ...
        n("moxie/core/utils/Basic", [], function() {
            ...
            function n(n, r) {
                ...
                e.extend(this, {
                    name: o || e.guid("file_"),
                    relativePath: "",
                    lastModifiedDate: r.lastModified ? new Date(r.lastModified) : r.lastModifiedDate || (new Date).toLocaleString()
                })
            }
                ...
                var o = this,
                    ...
                    l = e.extend({
                        ...
                        filter_by_extension: u(function() {
                            return !("Chrome" === n.browser && n.verComp(n.version, 28, "<") || "IE" === n.browser && n.verComp(n.version, 10, "<") || "Safari" === n.browser && n.verComp(n.version, 11, "<=") || "Firefox" === n.browser && n.verComp(n.version, 37, "<") || "iOS" === n.os || "Android" === n.os)
                        }()),
        ...
        r("plupload", [], function() {
            ...
            return function(e) {
                ...
                return i.IDLE = 1, i.PROCESSING = 2, i.PAUSED = 6, i.RESUMED = 7, i.DONE = 5, i.FAILED = 4, i.DESTROYED = 8, t.inherit(i, e), t.extend(i.prototype, {
                    start: function() {
                        var t = this.state;
                        return this.state === i.PROCESSING ? !1 : (this.startedTimestamp || (this.startedTimestamp = +new Date), this.state = i.PROCESSING, this.trigger("statechanged", this.state, t), this.trigger("started"), !0)
                    },
                    pause: function() {
                        var e = this.state;
                        return -1 === t.inArray(this.state, [i.IDLE, i.RESUMED, i.PROCESSING]) ? !1 : (this.processed = this.percent = 0, this.loaded = this.processed, this.state = i.PAUSED, this.trigger("statechanged", this.state, e), this.trigger("paused"), !0)
                    },
                    resume: function() {
                        var t = this.state;
            ...
            return function(r) {
                ...
                return t.inherit(s, r), t.extend(s.prototype, {
                    ...
                    pause: function() {
                        return s.parent.pause.call(this) ? (this.forEachItem(function(t) {
                            t.pause()
                        }), void 0) : !1
                    },
                    stop: function() {
                        return !s.parent.stop.call(this) || this.getOption("finish_active") ? !1 : (this.isActive() && this.forEachItem(function(t) {
                            t.stop()
                        }), void 0)
                    },
                    ...
                    destroy: function() {
                        ...
                        }), e.stop()) : (e.clear(), s.parent.destroy.call(this), e._queue = e.stats = null, !0)
                    }
                }), s
            }(i)
            ...
            function r(t) {
                ...
                n.call(this), this._options = {
                    ...
                    start: function() {
                        ...
                        this.startedTimestamp || (this.startedTimestamp = +new Date), this.state = n.PROCESSING, this.trigger("statechanged", this.state, p), a = new s, a.upload && (a.upload.onprogress = function(t) {
                            ...
                            return this.status < 200 || this.status >= 400 ? l.failed(t) : (l.done(t), void 0)
                        }, a.onerror = function() {
                            l.failed()
                        ...
                        try {
                            r = c.multipart ? c.url : i(c.url, c.params), a.open(c.http_method, r, !0), e.isEmptyObj(c.headers) || e.each(c.headers, function(t, e) {
                                a.setRequestHeader(e, t)
                            }), c.multipart ? (u = new o, e.isEmptyObj(c.params) || e.each(c.params, function(t, e) {
                                u.append(e, t)
                            }), u.append(c.file_data_name, t), a.send(u)) : ((e.isEmptyObj(c.headers) || !a.hasRequestHeader("content-type")) && a.setRequestHeader("content-type", "application/octet-stream"), a.send(t)), this.trigger("started")
                        } catch (d) {
                            l.failed()
                        }
                    },
            ...
            function a(i) {
                ...
                function _(t) {
                    t.forEachItem(function(t) {
                        t.destroy()
                    }), O.length && (e.each(O, function(t) {
                        t.destroy()
                    }), O = []), b.length && (e.each(b, function(t) {
                        t.destroy()
                    }), b = []), E = !1, y && y.destroy(), v && v.destroy(), I = y = v = null
                }
                var y, v, O = [],
                    b = [],
                    E = !1,
                ...
                n.call(this), e.extend(this, {
                    ...
                    init: function() {
                        ...
                        return t = n.getOption("preinit"), "function" == typeof t ? t(n) : e.each(t, function(t, e) {
                            ...
                            "function" == typeof o ? o(n) : e.each(o, function(t, e) {
                                n.bind(e, t)
                            }), t ? (E = !0, i = e.Runtime.getInfo(u()), y = new r(a), v = new s(a), n.trigger("Init", {
                                ruid: i.uid,
                    ...
                    setOption: function(t, i) {
                        return E && e.inArray(t, ["container", "browse_button", "drop_element", "runtimes", "multi_selection", "flash_swf_url", "silverlight_xap_url"]) > -1 ? this.trigger("Error", {
                            ...
                            option: t
                        }) : ("object" != typeof t && (i = p(t, i, this._options), y && y.setOption(t, i), v && v.setOption(t, i)), a.prototype.setOption.call(this, t, i), void 0)
                    },
                    refresh: function() {
                        O.length && e.each(O, function(t) {
                            t.trigger("Refresh")
                    ...
                    disableBrowse: function() {
                        R = arguments[0] !== h ? arguments[0] : !0, O.length && e.each(O, function(t) {
                            t.disable(R)
            ...
            return c("mime_types", function(t, i, n) {
                ...
                t && !i.size && i.size !== h ? (this.trigger("Error", {
                    code: e.FILE_SIZE_ERROR,
                    message: e.translate("File size error."),
                    file: i
                }), n(!1)) : n(!0)
