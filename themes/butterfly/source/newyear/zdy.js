...
var newYear = () => {
  ...
  jQuery(document).ready(function($) {
    $('#newYear').wpSuperSnow({
      flakes: ['https://qwe-oss.oss-cn-beijing.aliyuncs.com/image/yb1.webp', 'https://qwe-oss.oss-cn-beijing.aliyuncs.com/image/yb2.webp', 'https://qwe-oss.oss-cn-beijing.aliyuncs.com/image/yb3.webp'],
      totalFlakes: '100',
      zIndex: '1',
      maxSize: '30',
      maxDuration: '20',
