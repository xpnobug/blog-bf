    ...
    function init(config) {
        ...
        const onload = function() {
            ...
            if (config.banner === null){
                image.src = "http://p2.qhimg.com/bdm/1600_900_85/t012962abcf9cb49218.jpg";
            }
        ...
        success: function(data){
            ...
            for (let a = 0; a < data.models.Data.length; a++) {
                ...
                if (dataList._id === "shuoshuo"){
                    ...
                    for(var i = 0 ; comentList.length ; i++){
                        var pid = ""+comentList[i].pid+"";
                        var postList = dataList.data[0].post_list[i];
                        if (pid === post_id){
                            poster.init({
                                banner: postList.img_list[0].photo,
                                selector: '.poster_box',
                                title: dataList.data[0].user_name,
                                content: dataList.data[0].post_list[i].content,
                                logo: dataList.data[0].user_avatar,
                                qrcode: dataList.data[0].user_avatar,
                                description: dataList.data[0].user_desc,
                                callback: Posterdown
                            });
                            break;
                        }
